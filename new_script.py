...
def calculate_time_range():
    ...
    t1 = today.replace(hour=23, minute=59, second=59, microsecond=0)
...
def getNetworkClientOverview(network_id):
    ...
    '''
    response = dashboard.networks.getNetworkClientsOverview(network_id, resolution=7200, t0=t0, t1=t1)
